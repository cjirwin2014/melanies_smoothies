...
st.title(f":cup_with_straw: Smoothie Order Form :cup_with_straw:")
st.write(
  """
...
st.write("The name on your smoothie is", name_on_smoothie)
...
if ingredient_list:
    ...
    for fruit_chosen in ingredient_list:
        ...
        search_on = pd_df.loc[pd_df['FRUIT_NAM'] == fruit_chosen, 'SEARCH_ON'].iloc[0]
